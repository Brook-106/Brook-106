<!-- HEADER BANNER -->
<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:000000,100:0f2027&height=200&section=header&text=ADITHYAN%20M%20P&fontSize=45&fontColor=00FF66&animation=twinkling" width="100%" />
</p>
...
<p align="center">
  <a href="https://tryhackme.com/p/Adithyan.MP" target="_blank">
    <img src="https://img.shields.io/badge/TryHackMe-Adithyan.MP-212C42?style=for-the-badge&logo=tryhackme&logoColor=white" />
  </a>
  <a href="https://profile.hackthebox.com/profile/019e0360-3868-735c-9a53-3bdfcbd65c3f" target="_blank">
...
<table align="center">
  <tr>
    <td width="50%" valign="top">
      <h3>🛡️ About & SOC Focus</h3>
      <p>Motivated cybersecurity enthusiast specializing in <b>Defensive Security</b>, <b>SOC Operations</b>, and <b>Web Application Security Analysis</b>.</p>
      <ul>
        <li>🔭 <b>Current Focus:</b> Threat detection, log analysis, and network packet analysis.</li>
        <li>🎯 <b>Goal:</b> Building SOC analyst capabilities to protect enterprise environments.</li>
        <li>📍 <b>Location:</b> Kerala, India</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>⚡ Tech & Security Stack</h3>
      <p>
...
* **[VulnVault - Web Security Lab](https://github.com/Brook-106/vulnvault-vulnerable-web-lab)**  
  *Flask + SQLite application engineered for security analysis, OWASP Top 10 mitigation, and defensive validation.*
